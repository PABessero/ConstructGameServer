export default {
  ...
  //ssl_ca_bundle: "my.ca-bundle",	// path to ca-bundle if necessary
  ...
  ice_servers: [
    "stun:stun.l.google.com:19302", // Google-operated public STUN server
  ...
  // Period during which the number of flood kicks is counted. Note on the same timer it checks for
  // bans that have expired, so this should be less than the ban duration.
  //flood_ban_period: 600000,

  // If a client is flood-limit kicked this many times inside the flood ban period, they are banned.
  //flood_ban_limit: 10,

  // If a client is banned for repeatedly flooding, this is how long the ban lasts.
  //flood_ban_duration: 3600000,
